...
// Model version (default matches the latest stable gpt-4o-mini release)
...
// Deploy Application Insights + Log Analytics and connect them to the project so
// any module can demonstrate observability / tracing. Set to false for the
// leanest possible base (account + project + model only).
